      ...
      <ScrollView contentContainerStyle={s.scroll} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
        ...
        <View style={s.card}>
          ...
          <View style={s.inputWrap}>
            ...
            <TextInput style={s.input} placeholder="Correo electrónico" placeholderTextColor={C.inputPh} keyboardType="email-address" autoCapitalize="none" value={email} onChangeText={setEmail} />
          </View>
          ...
          <TouchableOpacity style={s.loginBtn} activeOpacity={0.85}>
            <Text style={s.loginBtnTxt}>→  Iniciar Sesión como Administrador</Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={s.secRow}>
          <Text style={s.secTxt}>🔐 Acceso seguro · Solo personal autorizado</Text>
        </View>
      </ScrollView>
...
const s = StyleSheet.create({
  ...
  badge:     { marginTop: 10, borderWidth: 1, borderColor: C.badgeB, borderRadius: 20, paddingHorizontal: 16, paddingVertical: 5, backgroundColor: C.badgeBg },
  badgeTxt:  { fontSize: 10, color: C.badgeTx, letterSpacing: 2, fontWeight: '600' },
